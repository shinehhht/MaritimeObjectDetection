...
python train_multimodality.py --workers 8 --device cpu --batch-size 1 --data foggy.yaml --img 640 640  --cfg model_cfg/training/yolov7-transformerx3_swin.yaml --weights 'yolov7_training.pt' --name yolov7_filter_fuse_foggy_pretrain_ --hyp data/hyp.scratch.p5.yaml #--fog_FLAG --ISP_FLAG # --Use_Simam_YOLO
